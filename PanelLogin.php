...
if($_POST)
{
    $user=$_POST['t12'];
    $pass=$_POST['t13'];
    if($user=='PanelToughX' && $pass=='12345')
    {
        header("Location:PanelAllot.php");
        exit;
    }
    else
    {
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="PanelLogin.php" method="post">
        <h2 class="form-signin-heading">Panel Security Sign In</h2>
            <div id="1">
